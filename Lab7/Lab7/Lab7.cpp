...
HWND hMainWnd;
CRITICAL_SECTION cs;
DWORD WINAPI ChangeTextFlag(int* new_flag);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    thread1 = CreateThread(NULL, 0u, (LPTHREAD_START_ROUTINE)ChangeTextFlag, &text_flag_1, 0, NULL);
    thread2 = CreateThread(NULL, 0u, (LPTHREAD_START_ROUTINE)ChangeTextFlag, &text_flag_2, 0, NULL);
